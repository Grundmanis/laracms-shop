            ...
            <div class="card-body">
                <div class="row no-styled-checkboxes">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="blocked" class="col-md-4 col-form-label text-md-right">{{ __('form.slug') }}</label>

                            <div class="col-md-6">
                                <input class="form-control" placeholder="{{ __('form.slug') }}" type="text" name="slug" value="{{ $shop->slug ? $shop->slug : old('slug') }}">
                            </div>
                        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('texts.reviews') }}</h4>
                </div>
                <div class="card-body">
